...
# bfs go randomly anywhere visit its neighbors
# dfs go explore one neighbor ignore any other neighbor, and continue until no more exploration, if things r reamained to explore come back n exlpore not visited neighbor but dont mention coming back